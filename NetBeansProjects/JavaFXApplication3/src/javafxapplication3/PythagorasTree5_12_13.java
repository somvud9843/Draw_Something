...
public class PythagorasTree5_12_13 extends JPanel {
    final int depthLimit = 15;
    float hue = 0.15f;
 
    public PythagorasTree5_12_13() {
    ...
    private void drawTree(Graphics2D g, float x1, float y1, float x2, float y2,
        ...
        float x4 = x1 - dy;
        float y4 = y1 - dx;
        float x5 = x4 + 12F/13F * (dx - dy);
        float y5 = y4 - 5F/13F * (dx + dy);
 ...
 */
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            f.add(new PythagorasTree5_12_13(), BorderLayout.CENTER);
            f.pack();
